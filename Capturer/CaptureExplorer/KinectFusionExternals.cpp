...
bool KinectFusionExternals::createConfFile(std::wstring wsConfPath, CREATE_CONF_EXT * sConf)
{
	if (sConf == nullptr)
		return false;
...
bool KinectFusionExternals::readConfFile(std::wstring wsConfPath, READ_CONF_EXT * sConf)
{
